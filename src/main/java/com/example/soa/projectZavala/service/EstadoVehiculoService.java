...
public class EstadoVehiculoService {
	...
	public List<ReporteUtilizacionDTO> obtenerReporteUtilizacionVehiculos() {
		return estadoVehiculoRepository.obtenerReporteUtilizacionVehiculos();
	}

	// actualizacion de estado
	public void actualizarEstadoPorMantenimiento() {
		estadoVehiculoRepository.actualizarEstadoVehiculosPorMantenimiento();
	}
